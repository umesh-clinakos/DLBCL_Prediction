...
UNION  select c.concept_id
  ...
  and ca.ancestor_concept_id in (42530708)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1310317,1338512,1308290,1551099,19120213)
